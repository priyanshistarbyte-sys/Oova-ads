...
$why = [
    ['Fraud Protection', 'Enterprise-grade safety with multi-layer filtration. We eliminate 98% of non-human activity pre-bid so you acquire verified users only.', 'See anti-fraud standards'],
...
<section class="section" id="why">
    <div class="container">
        ...
        <div class="why__grid">
            <?php foreach ($why as [$title, $desc, $cta]): ?>
                <div class="why-card">
                    <h3><?= $title ?></h3>
                    <p><?= $desc ?></p>
                    <a href="#"><?= $cta ?> →</a>
